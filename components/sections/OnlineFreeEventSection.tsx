      ...
      >
        ...
        >
          ...
          <h2 className="mt-5 text-4xl font-regular leading-[1.0] tracking-tight select-none text-white">
            Este é o evento que coloca você à frente da estação.
          </h2>

          <p className="text-xl md:text-xl text-zinc-300 max-w-xl mt-8 leading-relaxed font-regular select-none mx-auto sm:mx-0">
            No Festival, você terá acesso a:
          </p>

          <ul className="mt-6 space-y-4 text-lg text-zinc-300 max-w-xl mx-auto sm:mx-0">
            <li className="flex items-start gap-3">
              <span className="mt-2 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-white/80" />
              <span>Coleção Aurora de inverno antes de todos.</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-2 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-white/80" />
              <span>Mostruários ao vivo, direto da fábrica Xingyu.</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-2 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-white/80" />
              <span>Peças importadas com alta margem para revenda.</span>
            </li>
          </ul>
